...
public class GinRummyGame {
	...
	public static void main(String[] args) {
		...
		setPlayVerbose(true);
		new GinRummyGame(new SimpleGinRummyPlayer(), new ModifiedGinRummyPlayer()).play();
		
		ArrayList<Integer> P0Wins = new ArrayList<Integer>();
		...
		for(int j = 0; j < 50; j++){
			...
			int numGames = 1000;
			int numP1Wins = 0;
			GinRummyGame game = new GinRummyGame(new SimpleGinRummyPlayer(), new ModifiedGinRummyPlayer());
			...
			P0Wins.add(numGames - numP1Wins);
			P1Wins.add(numP1Wins);
		}
		
		int totalP0Wins = 0;
		int totalP1Wins = 1;
		for(int value: P0Wins){
			totalP0Wins += value;
		}
		for(int value: P1Wins){
			totalP1Wins += value;
		}
		System.out.printf("Total number of wins of P0 in 50 iterations of 1000 games (50000 games): %d", totalP0Wins);
		System.out.printf("Total number of wins of P1 in 50 iterations of 1000 games (50000 games): %d", totalP1Wins);
	}
}
